// Assuming @testing-library/jest-dom and @testing-library/react are already installed
...
class ResizeObserver {
  observe() {
    /* TODO document why this method 'observe' is empty */
  }
  unobserve() {
    /* TODO document why this method 'unobserve' is empty */
  }
  disconnect() {
